...
export const metadata = {
  ...
  timeToRead: 0,
  heroImage:
    "/contents/photo-studio-reservation/사진 스튜디오 예약 구글 설문지.png",
  tags: [
    "Reservation System",
    "Automation",
    "Google Apps Script",
...
<ImageWithCaption
  src="/contents/photo-studio-reservation/사진 스튜디오 예약 구글 설문지.png"
...
<ImageWithCaption
  src="/contents/photo-studio-reservation/인스타그램 DM 예약 접수 확인 메시지.jpeg"
...
<ImageWithCaption
  src="/contents/photo-studio-reservation/구글 설문지 예약 정보가 스프레드 시트에 정리1.png"
  alt="Google Forms Reservation Information Organized in Spreadsheet Example"
/>

<ImageWithCaption
  src="/contents/photo-studio-reservation/구글 설문지 예약 정보가 스프레드 시트에 정리2.png"
...
<ImageWithCaption
  src="/contents/photo-studio-reservation/내용작성 자동화되어 전송된 예약 안내 메일.png"
