...
export const metadata = {
  ...
  description: "foundation 모델, 파라미터, 사전 학습 용어 파헤치기",
...
<Image
  src="/contents/where-ai-is-going/modeling-안될과학.png"
  alt="모델링, 출처: 안될과학"
  width={1440}
  height={835}
...
<Image
  src="/contents/where-ai-is-going/pretraining-하정우.png"
  alt="사전학습, 출처: 하정우 네이버 AI 연구소장 강의 PPT"
  width={1440}
  height={835}
  style={{ width: "100%", height: "auto" }}
/>
...
<Image
  ...
  alt="ChinchillaScaling Law, 출처: 구글"
  width={1440}
  height={835}
  style={{ width: "100%", height: "auto" }}
/>
...
<Image
  ...
  alt="출처: LLaMA: Open and Efficient Foundation Language Models"
  width={1440}
  height={835}
  style={{ width: "100%", height: "auto" }}
/>
