...
1.  **Google Cloud Usage Fee**: A small Google Cloud fee, amounting to a few hundred KRW (less than a dollar) per month, may be incurred for service operation.
2.  **New User Benefit**: If you are new to Google Cloud, you can use the 90-day free credit to cover these costs, making it effectively free of charge during that period.
3.  **Installation Fee**: The installation fee for Mail Echo for Gmail is **KRW 50,000**.
    - **✨ July Special Discount**: For the month of July, we are offering a 30% discount, bringing the installation cost down to **KRW 35,000** (VAT included).

### ✉️ Contact

For installation inquiries or requests, please contact me at the email below.

- **Email**: kimjaahyun@kimjaahyun.com
